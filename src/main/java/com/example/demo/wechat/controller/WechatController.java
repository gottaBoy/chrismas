...
public class WechatController {
    ...
    public String authGet(
        ...
        if (this.wechatService.wxService.checkSignature(timestamp, nonce, signature)) {
            return echostr;
        }
    ...
    public String post(@RequestBody String requestBody,
        ...
        if (encType == null) {
            ...
            WxMpXmlMessage inMessage = WxMpXmlMessage.fromEncryptedXml(
                    requestBody, this.wechatService.wxService.getWxMpConfigStorage(), timestamp,
                    nonce, msgSignature);
            this.logger.debug("\n消息解密后内容为：\n{} ", inMessage.toString());
            WxMpXmlOutMessage outMessage = this.wechatService.route(inMessage);
            if (outMessage == null) {
            ...
            out = outMessage
                    .toEncryptedXml(this.wechatService.wxService.getWxMpConfigStorage());
        }
